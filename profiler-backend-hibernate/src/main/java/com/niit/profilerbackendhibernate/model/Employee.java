...
import com.niit.profilerbackendhibernate.util.ValidationRegExp;

@Component
@Entity
public class Employee extends ValidationRegExp {
	...
	@NotBlank(message = "Enter Username")
	@NotNull(message = "Enter valid Username")
	@Pattern(regexp = "((?=.*\\\\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%]){6,20})", message = "Min 6 and Max 20 characters. Atleast One Samll, One Capital, One Numeric and One Special Characters")
